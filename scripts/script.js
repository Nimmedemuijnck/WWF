...
document.querySelector('#knop2').addEventListener('click', function () {
  const content = document.querySelector('#content2');
  content.classList.toggle('show');
  this.classList.toggle('active');
});
document.querySelector('#knop3').addEventListener('click', function () {
...
(function () {
  createCaroCarrousel("bolletjesAndLinkButtons1");
  createCaroCarrousel("bolletjesAndLinkButtons2");
})();
